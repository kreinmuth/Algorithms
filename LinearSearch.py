...
#How it works, the algorithm searchs through a list to find a matching variable


def linearsearch(string_list, x):
   for i in range(len(string_list)): #Loops through the list from 0 t the max list length
      if string_list[i] == x:
